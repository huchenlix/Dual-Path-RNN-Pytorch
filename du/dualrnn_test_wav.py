...
def main():
    ...
    parser.add_argument(
        '-mix_scp', type=str, default='D:\speakdate\libri\dev-clean\LibriSpeech\data8000\c/0\mix.wav', help='Path to mix scp file.')
    parser.add_argument(
        '-yaml', type=str, default='./config/Dual_RNN/train_rnn.yml', help='Path to yaml file.')#
    parser.add_argument(
        '-model', type=str, default='D:\home\likai\data1\Dual-Path-RNN\checkpoint\Dual_Path_RNN/best.pt', help="Path to model file.")#
    parser.add_argument(
